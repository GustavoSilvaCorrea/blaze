...
<body>
    <div class="login-container">
        ...
        <form method="post" action="processa_deposito.php">
            ...
            echo "<pre>";
print_r($_SESSION); // Exibe o conteúdo completo da sessão
echo "</pre>";
            if (isset($_SESSION["cod_otario"])) {
                $cod_otario = $_SESSION["cod_otario"];
                echo "Código do usuário: " . $cod_otario;
            } else {
                echo "Usuário não está logado ou sessão expirou.";
            }
            ?>
            <input type="hidden" name="cod" value="<?php echo $cod_otario; ?>">
